...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C6194F980");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FFCD91C09");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483641083C6");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A403A50FEC");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A6ED77423");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132A9ED8692");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76EF001911");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A64607678C");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614A4BDE5AD");
